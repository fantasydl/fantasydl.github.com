	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".scroll-container").scroll(function(){
				var nTop = $(".scroll-container").scrollTop();
				var sHeight = $(".scroll-container").get(0).scrollHeight;
				var nHeight = $(".scroll-container").get(0).offsetHeight;
				var re = nTop - (sHeight - nHeight);
